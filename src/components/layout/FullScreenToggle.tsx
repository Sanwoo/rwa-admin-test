...
export function FullscreenToggle() {
  ...
  return (
    <Button variant="ghost" size="icon" onClick={toggleFullscreen} aria-label="Toggle Fullscreen" className="hidden md:inline-flex">
      <DynamicIcon name={isFullscreen ? 'Shrink' : 'Expand'} className="size-4" />
    </Button>
  )
}
